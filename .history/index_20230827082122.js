  <script>
    function performOperations() {
      ...
      var swapMessage = swapValues(numbers);
      ...
      var minPositiveNumberMessage = "Minimum positive number: " + (minPositiveNumber !== Number.POSITIVE_INFINITY ? minPositiveNumber : "N/A");
      var lastEvenNumberMessage = "Last even number: " + (lastEvenNumber !== -1 ? lastEvenNumber : "N/A");
      var swapMessage = "Swap result: " + swapMessage;
      var sortedArrayMessage = "Sorted array: " + sortedArray.join(", ");
      var firstPrimeNumberMessage = "First prime number: " + (firstPrimeNumber !== -1 ? firstPrimeNumber : "N/A");
      var integerCountMessage = "Number of integers in the array: " + integerCount;
      var comparisonMessage = "Positive numbers count vs Negative numbers count: " + compareCounts(positiveCount, numbers.length - positiveCount);
      ...
      document.getElementById('minPositiveNumber').textContent = minPositiveNumberMessage;
      ...
      document.getElementById('firstPrimeNumber').textContent = firstPrimeNumberMessage;
